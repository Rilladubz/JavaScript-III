/*
  ...
  Note: Research Inheritance for Javascript...

  In this file you will be creating three
  constructor functions: GameObject, CharacterStats, Humanoid.<<<< KEY WORD CONSTRUCTOR

  At the bottom of this file are 3 objects that all end up
  inheriting from Humanoid.  Use the objects at the bottom of the page
   to test your constructor functions.

   HUMANOID === CONTRUCTOR FUNCTION

  Each constructor function has unique properties and methods that
  are defined in their block comments below:<<<< HOW DO METHODS NESTED IN FUNCTIONS LOOK???
*/
